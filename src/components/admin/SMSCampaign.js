...
export const SMSCampaign = () => {
  ...
  const pages = [
    ...
    { name: 'Text Campaign', href: '/admindash/text', current: true }
  ]
                            ...
                            <tr key={person.id}>
                              <td className='px-6 py-4 whitespace-nowrap'>
                                <div className='flex items-center'>
                                  ...
                                  <div className='ml-4'>
                                    <div className='text-sm font-medium text-gray-900'>{person.legal_name}</div>
                                  </div>
                                </div>
                              </td>
                              <td className='px-6 py-4 whitespace-nowrap'>
                                <div className='text-sm text-gray-900'>{person.preferred_name}</div>
                              ...
                              <td className='px-6 py-4 whitespace-nowrap text-right text-sm font-medium'>
                                ...
                                >
                                  <PlusIconSolid className='h-5 w-5' aria-hidden='true'>{'  '}</PlusIconSolid>
                                  {`${person.phone}`}
                                </button>
                              </td>
                            </tr>
